...
#after generating a report for the chosen document, once you open the generated report, make sure to exit out of that document if you want to add more documents.
...
# Note: I tested this code on python version 3.9.7 (11.10.2022)
